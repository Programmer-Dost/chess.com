        ...
        <div className="w-full bg-[#302E2B] mx-auto">
            ...
            <div className="w-[96%] max-w-screen-lg mx-auto">
                <div className="mt-[4rem] lg:mt-[8rem] flex flex-col-reverse lg:grid lg:grid-cols-[45%,1fr] gap-20 lg:gap-28">
                    <div>
                        <h1 className="text-6xl text-white font-bold text-left mt-[-10px]">Your Ultimate <br/><span className="text-8xl">CHESS</span><br/> Destination</h1>
                        <p className="text-xl mt-6 text-white">Chess.100x is your premier destination for mastering the timeless game of chess. Whether you're a beginner looking to learn the basics or an experienced player aiming to sharpen your skills.</p>
                        ...
                        <Button 
                            ...
                            <img className="w-16 h-16" src="https://res.cloudinary.com/dcugqfvvg/image/upload/v1713650980/chess-solid-svgrepo-com_qbosf3.svg" alt="icon"/>
                                <p className="text-4xl">Play Online</p>
                        </Button>
                    </div>
                    <div>
                        <img className="rounded-2xl" src="https://res.cloudinary.com/dcugqfvvg/image/upload/v1713647295/standardboard.1d6f9426_asqzum.png" alt="chess-board" />
                    </div>
                </div>
            </div>
            <div className="mt-32 bg-[#262522] w-[96%] max-w-screen-lg mx-auto px-14 py-14 rounded-[36px]">
                <div className="lg:grid grid-cols-[45%,1fr] gap-28">
                    ...
                    <div className="mt-16 lg:mt-0">
                        <h1 className="text-6xl text-white font-bold text-left mt-[-10px]">Found an Issue!</h1>
                        <p className="text-xl mt-6 text-white">Please create an issue in our github website below. You are also invited to contribute on the project.</p>
                ...
                <div className="w-[96%] max-w-screen-lg mx-auto flex flex-row justify-between">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 mt-4">
                          <a href="https://github.com/hkirat" target="_blank"><img className="w-10 h-10" src="https://res.cloudinary.com/dcugqfvvg/image/upload/v1713657100/github-svgrepo-com_uosbko.svg" alt="icon"/></a>
                          <a href="https://www.youtube.com/@harkirat1" target="_blank"><img className="w-10 h-10" src="https://res.cloudinary.com/dcugqfvvg/image/upload/v1713658274/youtube-svgrepo-com_g2j3ac.svg" alt="icon"/></a>
                          <a href="https://twitter.com/kirat_tw" target="_blank"><img className="w-10 h-10" src="https://res.cloudinary.com/dcugqfvvg/image/upload/v1713658566/twitter-x_p3lis9.svg" alt="icon"/></a>
                        </div>
                    </div>
                </div>
            </footer>
